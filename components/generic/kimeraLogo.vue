<template >
<svg class="kimera-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 391.75 80.75">
  <g id="Layer_2" data-name="Layer 2">
    <g id="Ebene_1" data-name="Ebene 1">
      <path d="M23.36,0V47.5L42.5,19.91H69.19L48.61,48.05,69.75,79.42H41.38l-18-30.81V79.42H0V0Z" />
      ...
      <path d="M281,19.91h23.36l.22,9.57h.33c2-5.56,8.12-10.9,17-10.9h5V37.16h-7.79c-9.45,0-14.57,5-14.57,18.35V79.42H281.19V29Z" />
      <path
