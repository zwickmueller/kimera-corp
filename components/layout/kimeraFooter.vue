<template>
<footer class="kimera-footer" :class="this.$route.name ==  'info' ? 'is-info':''">
  <div class="flex adress kimera-text-filter-tags">
    <nuxt-link to="/home">kimera</nuxt-link> Holzstraße 15a 80469 München +49 173 9032725 post@kimeracorp.eu ®All Rights reserved ©kimera2022
  </div>
  <div class="">

    <div class="foot flex kimera-text-filter-tags">
      <div class="foot-link">
        <span role="link" @click="anim">Info</span>
      </div>
      <div class="foot-link">
        <span role="link" @click="anim">Privacy</span>
      </div>
      <div class="foot-link">
        <span role="link" @click="anim">Licensing</span>
      </div>
      <div class="foot-link">
        <span role="link" @click="anim">Products</span>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    const anim2 = this.tl.fromTo(".foot-spacer", {
      opacity: 0
    }, {
      opacity: 0,
      display: 'flex',
